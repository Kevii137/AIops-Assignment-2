"""
generate_dataset.py -- AIOps Module 3 Assignment, spam-detection scenario.
Generates the deterministic, synthetic 1,000-message dataset exactly as specified
...
print(f"Wrote {len(rows)} rows to spam_dataset.csv")
